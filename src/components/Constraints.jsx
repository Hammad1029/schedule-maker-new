...
const Constraints = ({ selectedCourses, slots }) => {
    ...
    return (
        <Box>
            <Button variant="contained" onClick={() => console.log(selectedCourses.map(course => ({
            ...
            <CourseListAccordion
                ...
                actions={[
                    {
                        callback: (i) =>
                            prioritized.filter(p => p.erp === i.erp).length === 0 && setPrioritized(prevState => ([...prevState, i])),
                        title: "Prioritize"
                    },
                    {
                        callback: (i) => setPrioritizedTeachers(prevState => ({
                            ...prevState,
            ...
            <CourseListAccordion
                ...
                actions={[
                    {
                        callback: ({ erp }) => setPrioritized(prevState => prevState.filter(i => i.erp !== erp)),
                        title: "Remove"
                    },
                ]} />
            ...
            <CourseListAccordion
                ...
                actions={[
                    {
                        callback: ({ subText: courseName }) => setPrioritizedTeachers(prevState => _.omit(prevState, courseName)),
                        title: "Remove"
                    },
                ]} />
            ...
            <Box>
                ...
                <FormControl>
                    ...
                    >
                        {slots.map(i => <MenuItem key={i.id} value={i.id}>{i.timing}</MenuItem>)}
                    </Select>
                </FormControl>
                <FormControl>
            ...
            <Box>
                ...
                <FormControl>
                    ...
                    >
                        {slots.map((i, j) => <MenuItem key={i.id} value={j}>{j}</MenuItem>)}
                    </Select>
                </FormControl>
                <FormControl>
